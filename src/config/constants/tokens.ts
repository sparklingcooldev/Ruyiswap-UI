...
const { MAINNET, TESTNET, AVAX_TESTNET, MUMBAI, FTMTESTNET, RINKEBY, CRONOSTESTNET } = ChainId
...
export const avaxtestnetTokens = {
  wbnb: new Token(
    AVAX_TESTNET,
...
export const ftmtestnetTokens = {
  wftmtestnet: new Token(
    FTMTESTNET,
