...
export const getMulticallAddress = (chainId) => {
  console.log("#######", addresses.multiCall[chainId]);
  return addresses.multiCall[chainId];
}
export const getLotteryV2Address = () => {
  return getAddress(addresses.lotteryV2)
}
export const getPancakeProfileAddress = (chainId) => {
...
export const getAnniversaryAchievement = (chainId) => {
  return addresses.AnniversaryAchievement[chainId];
}
