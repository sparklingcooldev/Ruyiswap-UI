...
export const getProfileContract = (chainId: number, signer ?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(profileABI, getPancakeProfileAddress(chainId), signer) as PancakeProfileContract
}
...
export const getAnniversaryAchievementContract = (chainId: number, signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(anniversaryAchievementAbi, getAnniversaryAchievement(chainId), signer)
}
